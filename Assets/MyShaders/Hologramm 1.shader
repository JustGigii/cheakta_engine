			...
			Pass
			{
				...
				CGPROGRAM
					...
					fixed4 fragmentFunc(v2f IN) : SV_Target{
						...
						// Rim Light
						//half rim = 1.0 - saturate(dot(IN.viewDir, IN.worldNormal));//old working

						//return pixelColor * _Color * (rim + _GlowIntensity);//old working
